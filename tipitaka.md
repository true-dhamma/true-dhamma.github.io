...
<div><style>#pl-m-ov{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.4);z-index:2147483647;display:none;align-items:center;justify-content:center;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;opacity:0;transition:opacity .3s;-webkit-backdrop-filter:blur(3px);backdrop-filter:blur(3px);}#pl-m-bx{background:#fff;padding:30px 25px;border-radius:12px;box-shadow:0 15px 35px rgba(0,0,0,0.2);width:320px;max-width:85vw;text-align:center;transform:translateY(20px);transition:transform .3s;}#pl-m-bx h3{margin:0 0 10px;font-size:20px;color:#222;line-height:1.3;font-weight:600;padding:0;border:none;}#pl-m-bx p{margin:0 0 25px;font-size:15px;color:#666;line-height:1.5;}#pl-m-bt{display:flex;gap:12px;}#pl-m-bt button{border:none;border-radius:6px;padding:12px 0;font-size:16px;cursor:pointer;transition:all .2s;outline:none;}#pl-m-bt button:hover{filter:brightness(0.95);}#pl-b-c{flex:1;background:#f0f0f0;color:#555;}#pl-b-r{flex:2;background:#c89b40;color:#fff;font-weight:600;}#pl-b-r:focus{box-shadow:0 0 0 3px rgba(200,155,64,0.3);}</style><div id="pl-m-ov"><div id="pl-m-bx"><h3>立即阅读《巴利圣典》</h3><p>简体中文普通话翻译</p><div id="pl-m-bt"><button id="pl-b-c">关闭</button><button id="pl-b-r">阅读</button></div></div></div><script>(function(){setTimeout(function(){var o=document.getElementById('pl-m-ov'),b=document.getElementById('pl-m-bx'),r=document.getElementById('pl-b-r'),c=document.getElementById('pl-b-c');if(!o)return;o.style.display='flex';setTimeout(function(){o.style.opacity='1';b.style.transform='translateY(0)';r.focus();},50);function x(){o.style.opacity='0';b.style.transform='translateY(20px)';setTimeout(function(){o.style.display='none';},300);}c.onclick=x;r.onclick=function(){var w=window.open('https://aipali.true-dhamma.com/tipitaka/','_blank');if(w)w.focus();x();};},5000);})();</script></div>
