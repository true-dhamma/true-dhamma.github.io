...
<div id="pali-modal-wrapper"><style>.pali-overlay{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.4);display:none;align-items:center;justify-content:center;z-index:9999;backdrop-filter:blur(2px);transition:opacity 0.3s ease}.pali-modal{background:#fff;padding:24px;border-radius:12px;box-shadow:0 10px 25px rgba(0,0,0,0.1);max-width:320px;width:85%;text-align:center;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;animation:paliFadeUp 0.4s ease;box-sizing:border-box}.pali-modal h3{margin:0 0 10px;font-size:18px;color:#333}.pali-modal p{margin:0 0 20px;font-size:14px;color:#666}.pali-btns{display:flex;gap:12px;justify-content:space-between;width:100%}.pali-btn{padding:10px 0;border-radius:6px;border:none;cursor:pointer;font-size:15px;transition:all 0.2s;outline:none;text-align:center}.pali-btn-close{flex:1;background:#e5e5e5;color:#666}.pali-btn-close:hover{background:#d4d4d4}.pali-btn-read{flex:2;background:#4a6fa5;color:#fff}.pali-btn-read:hover{background:#3b5984}.pali-btn-read:focus{box-shadow:0 0 0 3px rgba(74,111,165,0.4)}@keyframes paliFadeUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}</style><div id="pali-popup" class="pali-overlay"><div class="pali-modal"><h3>立即阅读《巴利圣典》</h3><p>简体中文普通话翻译</p><div class="pali-btns"><button class="pali-btn pali-btn-close" onclick="closePaliModal()">关闭</button><button id="pali-btn-read" class="pali-btn pali-btn-read" onclick="goPali()">阅读</button></div></div></div><script>function closePaliModal(){document.getElementById('pali-popup').style.display='none'}function goPali(){var w=window.open('https://aipali.true-dhamma.com/tipitaka/','_blank');if(w){w.focus()}closePaliModal()}setTimeout(function(){var m=document.getElementById('pali-popup');m.style.display='flex';document.getElementById('pali-btn-read').focus()},5000);</script></div>
