...
<div id="pali-modal-wrapper"><style>.pali-overlay{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.4);display:none;align-items:center;justify-content:center;z-index:9999;backdrop-filter:blur(2px);transition:opacity 0.3s ease}.pali-modal{background:#fff;padding:30px;border-radius:12px;box-shadow:0 15px 35px rgba(0,0,0,0.15);max-width:320px;width:85%;text-align:center;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;animation:paliFadeUp 0.4s ease}.pali-modal h3{margin:0 0 8px;font-size:20px;color:#333;font-weight:600}.pali-modal p{margin:0 0 25px;font-size:15px;color:#777;line-height:1.5}.pali-btns{display:flex;flex-direction:column;gap:10px}.pali-btn{width:100%;padding:12px 0;border-radius:8px;border:none;cursor:pointer;font-size:16px;font-weight:500;transition:all 0.2s;outline:none}.pali-btn-read{background:#4a6fa5;color:#fff;box-shadow:0 4px 12px rgba(74,111,165,0.2)}.pali-btn-read:hover{background:#3b5984}.pali-btn-read:focus{box-shadow:0 0 0 3px rgba(74,111,165,0.4)}.pali-btn-close{background:#e5e5e5;color:#666}.pali-btn-close:hover{background:#d8d8d8}@keyframes paliFadeUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}</style><div id="pali-popup" class="pali-overlay"><div class="pali-modal"><h3>立即阅读《巴利圣典》</h3><p>简体中文普通话翻译</p><div class="pali-btns"><button id="pali-btn-read" class="pali-btn pali-btn-read" onclick="goPali()">阅读</button><button class="pali-btn pali-btn-close" onclick="closePaliModal()">关闭</button></div></div></div><script>function closePaliModal(){document.getElementById('pali-popup').style.display='none'}function goPali(){window.open('https://aipali.true-dhamma.com/tipitaka/','_blank');closePaliModal()}setTimeout(function(){var m=document.getElementById('pali-popup');m.style.display='flex';document.getElementById('pali-btn-read').focus()},5000);</script></div>
